...
var arrow_height = $('.product__media-list-wrapper').height() / 2 - 28;
$('.product-list__prev-next').css('top', arrow_height);

// footer event
var i = 0;
$('.footer__item-title').click(function() {
    if (i == 0) {
        $(this).parent().find('.footer__item-content').show();
        $(this).find('.minus').show();
        $(this).find('.plus').hide();
        i = i + 1;
    } else {
        $(this).parent().find('.footer__item-content').hide();
